...
/* 0 if you do not want the ANGIE Adapter. */
#define BUILD_ANGIE 1
...
/* 0 if you don't want to debug via Direct Mem. */
#define BUILD_DMEM 0
...
/* 0 if you don't want the Remote Bitbang driver. */
...
/* define if libgpiod v1 has line request flags bias */
/* #undef HAVE_LIBGPIOD1_FLAGS_BIAS */
